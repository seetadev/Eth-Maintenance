		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dynamic Form",
									"targetURL": "#comsapdynamicform1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapdynamicform1-display": {
								"semanticObject": "comsapdynamicform1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.dynamicform1",
									"url": sap.ui.require.toUrl("com/sap/dynamicform1")
								}
							}
						}
					}
